...
b22 = Book.create(title: "This is Your Mind on Plants", author: "Michael Pollan", pages: rand(100...500), img_url: "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1606111590l/56015023._SY475_.jpg", bookspine_img: "https://i.ibb.co/41QkH4c/bookorange.png") 
b23 = Book.create(title: "Oryx and Crake", author: "Margaret Atwood", pages: rand(100...500), img_url: "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1494109986l/46756.jpg", bookspine_img: "https://i.ibb.co/41QkH4c/bookorange.png") 
b24 = Book.create(title: "The Paper Menagerie", author: "Ken Liu", pages: rand(100...500), img_url: "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1511290092l/24885533._SY475_.jpg", bookspine_img: "https://i.ibb.co/41QkH4c/bookorange.png") 
b25 = Book.create(title: "The Cybernetic Hypothesis", author: "Tiqqun", pages: rand(100...500), img_url: "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1557334734l/45688219._SY475_.jpg", bookspine_img: "https://i.ibb.co/41QkH4c/bookorange.png") 
...
#Review
r1 = Review.create(user_id: u1.id, book_id: b1.id, content: Faker::Quote.famous_last_words)
...
r4 = Review.create(user_id: u2.id, book_id: b2.id, content: Faker::Quote.famous_last_words)
r5 = Review.create(user_id: u3.id, book_id: b1.id, content: Faker::Quote.yoda)
r6 = Review.create(user_id: u3.id, book_id: b2.id, content: Faker::Quote.singular_siegler)
r7 = Review.create(user_id: u3.id, book_id: b3.id, content: Faker::Quote.famous_last_words)
r8 = Review.create(user_id: u3.id, book_id: b4.id, content: Faker::Quote.yoda)
r9 = Review.create(user_id: u1.id, book_id: b3.id, content: Faker::Quote.famous_last_words)
r10 = Review.create(user_id: u1.id, book_id: b4.id, content: Faker::Quote.yoda)
r11 = Review.create(user_id: u1.id, book_id: b5.id, content: Faker::Quote.singular_siegler)
r12 = Review.create(user_id: u2.id, book_id: b5.id, content: Faker::Quote.famous_last_words)
r13 = Review.create(user_id: u1.id, book_id: b6.id, content: Faker::Quote.famous_last_words)
r14 = Review.create(user_id: u1.id, book_id: b7.id, content: Faker::Quote.yoda)
r15 = Review.create(user_id: u2.id, book_id: b7.id, content: Faker::Quote.yoda)
r15 = Review.create(user_id: u3.id, book_id: b8.id, content: Faker::Quote.singular_siegler)
r16 = Review.create(user_id: u1.id, book_id: b8.id, content: Faker::Quote.yoda)