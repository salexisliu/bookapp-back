...
r7 = Review.create(user_id: u3.id, book_id: b1.id, content: Faker::Quote.yoda)
r8 = Review.create(user_id: u3.id, book_id: b2.id, content: Faker::Quote.yoda)
r9 = Review.create(user_id: u3.id, book_id: b1.id, content: Faker::Quote.yoda)
r10 = Review.create(user_id: u3.id, book_id: b2.id, content: Faker::Quote.yoda)